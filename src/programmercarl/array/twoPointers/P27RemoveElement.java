...
public class P27RemoveElement {
    ...
    class Solution {
        /**
         * 解题思路：双指针
         * 1、定义slow 与fast，同一方向移动
         * 2、遇到要移除的数字，slow 停下，fast 移动到下一位，fast 一直找到不等于val 数字，fast 覆盖slow
         * 3、slow 不等于需移除数字后，slow 继续移动。fast 移动到数组尾部时，slow 为新数组长度
         */
